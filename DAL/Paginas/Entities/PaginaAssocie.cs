...
namespace DAL.Paginas {
	...
	//
	internal sealed class PaginaAssocieMapper : EntityTypeConfiguration<PaginaAssocie> {

		public PaginaAssocieMapper() {

			this.ToTable("tb_pagina_associe");
