...
namespace WEB.Areas.Financeiro.Controllers{
    ...
    public class TituloDespesaAlteracaoDadosController : Controller{

        private ITituloDespesaAlteracaoDadoBL Instance;
        private ITituloDespesaAlteracaoDadoBL OAlteracaoDadoBL
            => Instance = Instance
            ?? new TituloDespesaAlteracaoDadoBL();
