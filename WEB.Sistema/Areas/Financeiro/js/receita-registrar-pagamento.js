function ReceitaRegistrarPagamentoClass() {
    ...
    this.onSuccessPagamentoForm = function (response) {
        ...
        ReceitaRegistrarPagamento.showCamposAdicionais($("#idMeioPagamento"));
    };
    ...
    this.showCamposAdicionais = function (element) {
        ...
        if (idMeioPagamento === idMeioPagamentoBoleto) {
            ...
            $(classeLabelDocumento).html("<i class=\"fa fa-asterisk label-required\"></i> N&uacute;mero do Boleto");
        ...
        if (idMeioPagamento === idMeioPagamentoCheque) {
            ...
            $(classeLabelDocumento).html("<i class=\"fa fa-asterisk label-required\"></i> N&uacute;mero do Cheque");
            $(classeBoxDocumento).show();
            return;
        }

        if (idMeioPagamento === idMeioPagamentoDeposito || idMeioPagamento === idMeioPagamentoBitlink || 
            idMeioPagamento === idMeioPagamentoPagSeguro || 
            idMeioPagamento === idMeioPagamentoDinheiro || 
            idMeioPagamento === idMeioPagamentoTransferencia || 
            idMeioPagamento === idMeioPagamentoGuia || 
            idMeioPagamento === idMeioPagamentoDebitoConta) {
    ...
    this.carregarFormasPagamento = function (idMeioPagamento) {
        ...
        var comboForma = $("#ReceitaRegistrarPagamento_idFormaPagamento");
...
var ReceitaRegistrarPagamento = new ReceitaRegistrarPagamentoClass();

$(document).ready(function(){
    ReceitaRegistrarPagamento.init();
});
