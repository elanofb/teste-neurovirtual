...
namespace WEB.Areas.Financeiro.ViewModels{
    ...
    public class BaixaTituloReceitaPagamentoFormValidator : AbstractValidator<BaixaTituloReceitaPagamentoForm>{

        public BaixaTituloReceitaPagamentoFormValidator(){
