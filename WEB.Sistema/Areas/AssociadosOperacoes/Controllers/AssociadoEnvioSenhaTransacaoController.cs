...
namespace WEB.Areas.AssociadosOperacoes.Controllers {
	...
	public class AssociadoEnvioSenhaTransacaoController : Controller {
		...
		private IAssociadoNovaSenhaNotificacaoBL OAssociadoNovaSenhaNotificacaoBL => _IAssociadoNovaSenhaNotificacaoBL = _IAssociadoNovaSenhaNotificacaoBL ?? new AssociadoNovaSenhaTransacaoNotificacaoBL();
	    ...
	    public ActionResult gerarSenhaAleatoria(EnvioSenhaTransacao ViewModel) {

            var senhaGerada = UtilString.randomNumber(6);
