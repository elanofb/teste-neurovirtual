...
namespace WEB.Areas.AssociadosOperacoes.Controllers {
	...
	public class AssociadoEnvioLinkRecuperacaoSenhaController : Controller {

		//Atributos
		private IAssociadoRecuperacaoSenhaNotificacaoBL _IAssociadoRecuperacaoSenhaNotificacaoBL;
		private IPessoaEmailConsultaBL _PessoaEmailConsultaBL;
		private INaoAssociadoBL _NaoAssociadoBL;

		//Propriedades
		private IAssociadoRecuperacaoSenhaNotificacaoBL OAssociadoRecuperacaoSenhaNotificacaoBL => _IAssociadoRecuperacaoSenhaNotificacaoBL = _IAssociadoRecuperacaoSenhaNotificacaoBL ?? new AssociadoRecuperacaoSenhaNotificacaoBL();
	    ...
	    public ActionResult enviarLinkSenha(AssociadoFiltroVM DadosConsulta) {
            ...
            var ORetorno = this.OAssociadoRecuperacaoSenhaNotificacaoBL.registrarEmails(listaAssociados);
