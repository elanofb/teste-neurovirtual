function EnvioSenhaTransacaoClass(){
    ...
    this.init = function () {
        ...
        this.urlEnvioNovaSenha = $("#baseUrlGeral").val() + "AssociadosOperacoes/AssociadoEnvioSenhaTransacao/modal-enviar-nova-senha";
    ...
    this.enviarParaSelecionados = function () {
        ...
        $.post(this.urlEnvioNovaSenha, postData, function (response) {
            ...
            EnvioSenhaTransacao.onSuccessAberturaModal(response);
    ...
    this.gerarSenhaAleatoria = function() {
        ...
        var url = $("#baseUrlGeral").val() + "AssociadosOperacoes/AssociadoEnvioSenhaTransacao/gerar-senha-aleatoria";
    
        $.get(url, {}, function(response) {

            $("#formEnvioSenhaTransacao").find("#novaSenha").val(response.senhaGerada);
...
var EnvioSenhaTransacao = new EnvioSenhaTransacaoClass();

$(document).ready(function(){
    EnvioSenhaTransacao.init();
});
