...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "Nada foi localizado."; },
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Digite " + n + " ou mais caracter" + (n == 1? "" : "es"); },
...
function iniciarSelect2() {
    $("select[data-toogle=select2]").each(function (e, i) {
        $(this).select2();
    });
}
