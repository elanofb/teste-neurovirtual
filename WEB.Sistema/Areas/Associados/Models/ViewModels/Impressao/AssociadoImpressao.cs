...
namespace WEB.Areas.Associados.ViewModels {
    ...
    public abstract class AssociadoImpressao {
        ...
        protected void incluirDadosContato() {
            ...
            this.Replace("#ENDERECO_WEB#", "Associado.Pessoa.enderecoWeb", Associado.Pessoa.enderecoWeb);
        }
        ...
        private void incluirDadosEmail() {
            ...
            var listaEmails = Associado.Pessoa.listaEmails.Where(x => !string.IsNullOrEmpty(x.email)).ToList();
...
/*
            if (Associado.Pessoa.listaPessoaContato.Count == 0) {
            ...
            foreach (var OContato in Associado.Pessoa.listaPessoaContato) {
...
*/
        ...
        protected void incluirListaRepresentantes() {
            ...
            //if (Associado.listaRepresentante.Count == 0) {
            ...
            //foreach (var ORepresentante in Associado.listaRepresentante) {
        ...
        protected void incluirListaAreasAtuacao() {
            ...
            if (Associado.idTipoAssociado == TipoAssociadoConst.PROVEDOR || Associado.idTipoAssociado == TipoAssociadoConst.PROVEDOR_FORNECEDOR) {
            ...
            //if (Associado.listaAreaAtuacao.Count == 0) {
            ...
            //foreach (var OAreaAtuacao in Associado.listaAreaAtuacao) {
        ...
        protected void incluirListaTitulos() {
            ...
            //if (Associado.listaTitulo.Count == 0) {
            ...
            //foreach (var OTitulo in Associado.listaTitulo) {
