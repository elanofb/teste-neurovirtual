...
namespace WEB.Areas.NaoAssociados.ViewModels {
    ...
    [Validator(typeof(NaoAssociadoCadastroPJFormValidator))]
    public class NaoAssociadoCadastroPJForm {
        ...
        //Construtor
        public NaoAssociadoCadastroPJForm() {
        ...
        private void carregarGrupos() {
            ...
            var query = this.OConfiguracaoGrupoBL.listarFromCacheOrDefault(idOrganizacao, true)
                                            .Where(x => x.idTipoCampoCadastro == TipoCampoCadastroConst.NA_PJ && x.ativo != false);
        ...
        private void carregarCampos(bool flagTelaEdicao = false) {
            ...
            var query = this.OConfiguracaoCampoBL.listarFromCacheOrDefault(idOrganizacao, true)
                                            .Where(x => x.idTipoCampoCadastro == TipoCampoCadastroConst.NA_PJ && x.flagAreaAdm == true && x.ativo != false);
