...
namespace BLL.Pedidos {
    ...
    public class OnPedidoPreparadoHandler : IHandler<object> {
		...
		public void execute(object source) {
            ...
            try {
                ...
                UtilLog.saveError(ex, "Erro ao executar o evento OnPedidoPreparadoHandler.");
        ...
        private void registrarOcorrencia(int id, string observacoes) {
            ...
            this.OPedidoOcorrenciaBL.criarOcorrenciaPreparado(id, observacoes);
