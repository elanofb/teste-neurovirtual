...
namespace BLL.NaoAssociados.Events {
	...
	public class OnNaoAssociadoCadastradoHandler : DefaultBL, IHandler<object> {
        ...
        public void execute(object source) {
			try {
    	        ...
    	        this.OAssociado.TipoAssociado = this.OTipoAssociadoBL.carregar(UtilNumber.toInt32(OAssociado.idTipoAssociado), this.OAssociado.idOrganizacao);
