...
namespace BLL.Associados.Events {
	...
	public class OnNaoAssociadoReativacaoHandler : IHandler<object> {
		...
		public void gerarOcorrencia() { 
			...
			Ocorrencia.idOcorrenciaRelacionamento = OcorrenciaRelacionamentoConst.idReativacaoNaoAssociado;
