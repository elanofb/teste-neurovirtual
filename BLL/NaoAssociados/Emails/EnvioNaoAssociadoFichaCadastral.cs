...
namespace BLL.Email {
	...
	public class EnvioNaoAssociadoFichaCadastral : EnvioEmailAdapter {
		...
		//Private Construtor
		private EnvioNaoAssociadoFichaCadastral(int idOrganizacaoParam, List<string> listaDestino, List<string> listaCopia, List<string> listaCopiaOculta) :
			base(idOrganizacaoParam, listaDestino, listaCopia, listaCopiaOculta) {
		}

		//Factory
		public static EnvioNaoAssociadoFichaCadastral factory(int idOrganizacaoParam, List<string> listaDestino, List<string> listaCopia, List<string> listaCopiaOculta = null) { 
			return new EnvioNaoAssociadoFichaCadastral(idOrganizacaoParam, listaDestino, listaCopia, listaCopiaOculta);
		}
		...
		protected override string capturarConteudoHTML(string arquivoHTML) {
			...
			string conteudoHTML = OConfiguracao.corpoEmailFichaNaoAssociado;
