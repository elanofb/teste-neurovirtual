	...
	public class OnSenhaAlteradaHandler : IHandler<object> {
		...
		public void execute(object source) {
			try {
				...
				UtilLog.saveError(ex, String.Format("Erro no manipulador do evento de alteracao de senha do membro {0}", this.OAssociado.Pessoa.nome));
			}
		}
		...
		public void gerarOcorrencia() { 
			...
			Ocorrencia.observacao = "Senha alterada através da área do membro.";
